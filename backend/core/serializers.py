...
from .models import Medicamentos, Pacientes, Roles, Usuarios, HistoriaClinicas, Enfermedades, Diagnosticos, Tratamiento
from .models import TratamientoMedicamento, Inventario, EntregaMedica, DetalleEntregaMedicamento,MovimientoMedicamento
from .models import AplicacionMedicamento, TipoInsumo, Insumos, DetalleEntregaInsumos, EntregaInsumo, MovimientoInsumo
from .models import Bitacora, Actividades, SignosVitales, TipoEvento, TipoEmergencia, EventosAdversos, ImagenesEventoAdverso
